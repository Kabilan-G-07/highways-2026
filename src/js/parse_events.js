...
function parseLine(line) {
    ...
    return {
        ...
        description: "Join the multi-disciplinary " + title + " event by " + clubName + ". A major highlight of Highways'26.",
        rules: [
            "Mandatory registration via the Highways'26 app.",
            "Bring your college ID card for venue verification.",
            "Judges' decision will be final and cannot be disputed.",
            "Report to the assigned hall at least 15 minutes early."
        ],
        prizePool,
        regType,
        ...
        pocs: [
            { name: clubName + " Team", phone: "Details in App" }
        ]
    };
}
